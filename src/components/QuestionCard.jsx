...
import { CheckCircle2, XCircle, Lightbulb, ArrowRight, Waves } from 'lucide-react';
import { useProgress } from '../contexts/ProgressContext';
import RemedialModal from './RemedialModal';

// Custom horseshoe SVG component
const Horseshoe = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M12 2C7.58 2 4 5.58 4 10v8l2 2m0 0h2m-2 0v0m12-10C18 5.58 14.42 2 10 2m8 8v8l-2 2m0 0h-2m2 0v0" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

// Custom field hockey stick SVG component
const HockeyStick = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M4 20L12 4M12 4L14 8M12 4L10 8" strokeLinecap="round" strokeLinejoin="round"/>
...
export default function QuestionCard({
  ...
  // Get themed icon for this topic
  const HintIcon = topicId === 'intro_sampling' ? Waves : 
                   topicId === 'probability_basics' ? Horseshoe :
                   topicId === 'data_collection' ? HockeyStick :
                   Lightbulb;
        ...
        {showFeedback && (
          <div
            className={`p-4 rounded-lg mb-6 ${
              isCorrect 
                ? `bg-green-50 border-l-4 border-green-500 ${animateSuccess ? 'animate-success' : ''}` 
                : `bg-red-50 border-l-4 border-red-500 ${animateShake ? 'animate-shake' : ''}`
            }`}
          >
